<template>
    <div>
        <app-layout>
            ...
            <div class="w-full h-screen flex justify-center py-8">
                <div class="border shadow bg-white w-3/5 h-full align-middle content-center rounded">
                    ...
                    <form>
                        <div class="container px-3 py-3 flex flex-col">
                            <div class="flex flex-row gap-4 justify-center w-full h-full content-center py-14">
                                <div class="w-1/4">
                                    <label for="degree_id">
                                    ...
                                    <select 
                                        ...
                                        id="degree_id" 
                                        class="appearence-none w-full bg-gray-200 text-gray-700 border border-gray-200 py-3 px-4 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
    ...
    data() {
        return {
            createForm: this.$inertia.form({
                period_description: '',
                period_opened_at: new Date(),
                period_closed_at: new Date(),
                degree_id: null
            })
        }
    },
